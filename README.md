...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=2EC4B6&center=true&vCenter=true&width=600&lines=Building+scalable+CI%2FCD+pipelines;Automating+infrastructure+with+Terraform;Deploying+on+Kubernetes;Always+learning%2C+always+shipping" alt="Typing SVG" />
</p>
...
- 🔭 Currently deepening my skills in **Cloud Infrastructure, Kubernetes & Infrastructure as Code**
- 🌱 Focused on building **production-grade CI/CD pipelines** and **automated deployment workflows**
- 🛠️ I enjoy solving real-world infrastructure problems — from provisioning to monitoring to scaling
- 💡 Passionate about **automation-first** engineering: if it can be scripted, it should be
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=aws,docker,kubernetes,terraform,ansible,jenkins,githubactions,python,bash,linux,git,github,prometheus,grafana,nginx&theme=dark" />
</p>
...
<p align="center"><i>⚡ Open to DevOps / Cloud Engineer opportunities — let's build something reliable and scalable together.</i></p>
